...
import 'formularioVehiculo.dart';
...
void main() {
  runApp(VehiculosGerente());
}

class VehiculosGerente extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => FormularioVehiculo()),
          );
        },
        child: Icon(
          Icons.add,
